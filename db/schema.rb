...
ActiveRecord::Schema.define(version: 2021_06_24_063335) do
  ...
  create_table "custom_gold_loans", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "full_name"
    t.string "mobile_number"
    t.string "email"
    t.integer "loan_purpose"
  ...
  create_table "custom_insurances", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "full_name"
    t.string "mobile_number"
    t.string "email"
    t.integer "loan_purpose"
  ...
  create_table "refer_earns", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "full_name"
    t.string "mobile_number"
    t.string "product_name"
